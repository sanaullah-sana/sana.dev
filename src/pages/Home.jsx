...
const projects = [
  {
    ...
    description: "This UI is About Board of Boiler Engineers. It was a real-world Project Assigned to I made its UI.",
    image: boilerImg, 
  ...
  },
  {
    ...
    description: "This is a Basic E-Commerce Website. (Fetching Products) Still Under Construction.",
    image: furniroImg,
    ...
    {
    title: "Whitepace",
    description: "This is a Responsive landing Page. I Converted its design from Figma to Code.",
    image: whitepaceImg,
    ...
    description: "This a Restaurant Website Made with WordPress Elementor. I have worked on 2 real world WordPress Projects.",
    image: restaurantImg,
    ...
    description: "This is a static Landing Page. I converted its figma disign to Code.",
    image: postivousPage,
    tech: ["HTML", "CSS", "JS", "Bootstrap"],
...
<section className="min-h-screen bg-white px-4 py-16">
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between">
    ...
    <div className="md:w-1/2 mb-12 md:mb-0">
      <h1 className="md:mt-15 mt-20 text-2xl sm:text-3xl md:text-4xl font-bold mb-4 leading-snug text-center md:text-left">
        Hi! I'm <span className="text-blue-600">Sana Ullah</span> —<br />
        A Passionate{' '}
        <span className="text-green-600">
          <Typewriter
            words={['Frontend Developer', 'WordPress Developer', 'React Developer']}
            loop={false}
            cursor
            cursorStyle="|"
            typeSpeed={60}
      ...
      <p className="text-gray-700 mb-6 text-center md:text-left">
        I'm a Frontend Developer with a passion for building clean and user-friendly web interfaces.
        I love turning ideas into reality using code. Currently I am focusing on Frontend After Frontend I will Start Projects in Backend.(MERN Stack)
      </p>
...
<section id="skills" className="py-16 bg-gray-50">
  <div className="max-w-6xl mx-auto px-4 text-center">
    <h2 className="text-xl sm:text-2xl md:text-3xl font-bold my-10">My Skills</h2>
...
<section id="projects" className="py-16 bg-white">
  <div className="max-w-6xl mx-auto px-4">
    <h2 className="text-2xl sm:text-3xl font-bold text-center my-12">My Projects</h2>
          ...
          <div className="p-5">
            ...
            <div className="flex flex-wrap gap-2 text-xs text-gray-600 mb-4">
              {project.tech.map((tech, i) => (
                <span key={i} className="bg-blue-100 px-2 py-1 rounded-4xl text-blue-900">{tech}</span>
              ))}
            </div>
...
{/* About Section */}
<section id="about" className="bg-gray-100 py-5 md:py-22 px-4 sm:px-6 md:px-10 lg:px-16">
  <div className="max-w-4xl mx-auto">
    ...
    <p className="text-sm sm:text-base md:text-lg text-gray-800 mb-6 leading-relaxed">
      ...
      <motion.span
        ...
        className="bg-yellow-200 px-1 font-semibold"
      >
        Sana Ullah
      </motion.span>
      , a dedicated Frontend Developer from Pakistan who loves building clean,
    ...
    <p className="text-sm sm:text-base md:text-lg text-gray-800 mb-6 leading-relaxed">
      ...
      , and have developed multiple web projects featuring clean designs and
    ...
    <p className="text-sm sm:text-base md:text-lg text-gray-800 mb-6 leading-relaxed">
      ...
      , exploring modern technologies, and building scalable, user-friendly
      frontend solutions.
    </p>
    ...
    <motion.blockquote
      ...
      whileInView="visible"
      viewport={{ once: false, amount: 0.6 }}
      className="bg-yellow-200 px-4 py-3 italic text-gray-700 rounded-md text-center text-base sm:text-lg"
    >
...
{/* Contact Section */}
<section id="contact" className="bg-gray-100 py-24 px-4 sm:px-6 lg:px-16">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div>
        ...
        <p className="text-gray-700 mb-6">
          I'm always open to exploring new opportunities, collaborating on exciting projects, or simply chatting about tech and web development.
        </p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <ul className="space-y-4 text-gray-700">
            ...
            <li className="flex items-center gap-2">
              <span><MdEmail /></span>
              <a href="mailto:khansan130q@gmail.com" className="hover:underline">
                khansan130q@gmail.com
              </a>
            </li>
            <li className="flex items-center gap-2">
              <span><FaLinkedin className='bg-blue-700 text-white' /></span>
              <a
